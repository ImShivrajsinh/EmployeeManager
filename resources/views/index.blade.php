  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Employee Here..</h5>
      ...
      <form action="#" method="POST" id="add_employee_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
          ...
          <div class="my-2">
            <label for="img">Select ProfilePic</label>
    ...
    <div class="modal-content">
      ...
      <form action="#" method="POST" id="edit_employee_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
          ...
          <div class="my-2">
            <label for="img">Select Profle Pic</label>
      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-header bg-info d-flex justify-content-between align-items-center">
            <h3 class="text-dark">Employees List</h3>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEmployeeModal"><i
                class="bi-plus-square me-2"></i>Add Employee</button>
          </div>
